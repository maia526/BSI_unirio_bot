...
def texto_desconhecido(update: Update, context: CallbackContext):
    update.message.reply_text("Desculpe, eu não entendi, você falou: '%s'" % update.message.text)
...
updater.dispatcher.add_handler(CommandHandler('calendario', calendario_mensagem))
